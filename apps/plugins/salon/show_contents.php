                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="nav-link" href="/<?php echo home; ?>/admin/services/services-by-salon/?vendor_id=<?php echo $pv['created_by']; ?>&salon_id=<?php echo $pv['id']; ?>"> <i class="fa-solid fa-rectangle-list"></i> Services </a>
                                            </td>
                                            <td>
                                                <?php echo $vndrnme; ?>
                                            </td>
